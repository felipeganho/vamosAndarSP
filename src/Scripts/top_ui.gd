...
#		GameDataManager.level_info[current_level]["stars unlocked"] = 1
	...
	if current_score > 700 and get_node("/root/Variables").scene == 5:
		get_node("/root/Variables").scene = 0
